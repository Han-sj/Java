...
public class ArrayTest {
	public static void main(String[] args) {
		...
		// 배열 원소 출력
		System.out.println("arr1 첫 번째 원소 : " + arr1[0]);
		System.out.println("arr1 두 번째 원소 : " + arr1[1]);
		System.out.println("arr1 네 번째 원소 : " + arr1[3]);
		System.out.println("arr2 첫 번째 원소 : " + arr2[0]);
		System.out.println("arr2 세 번째 원소 : " + arr2[2]);
		System.out.println("arr3 첫 번째 원소 : " + arr3[0]);
		System.out.println("arr3 네 번째 원소 : " + arr3[3]);
		...
		for (char c : arr2) { // for each문 : 배열 전용 반복문
			System.out.println("arr2 원소 : " + c);
		}
		for (String s : arr3) { // for each문 : 배열 전용 반복문
			System.out.println("arr3 원소 : " + s);
		}
